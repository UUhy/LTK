...
class alignmentMark(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("res", self.TypeDouble, "Resolution [um]", default = 0.5)
  ...
  def produce_impl(self):
    ...
    vPitch = 8*scale
    vGap = 0
    vPosL = pya.Point(-120000*scale,cPos.y)
    vPosB = pya.Point(cPos.x,-120000*scale)
    
    # Mask number parameters
    mLineWidth = 4*scale
    mPos = pya.Point(140000*scale,140000*scale)
